...
public class SupplierCustomIdGenerator extends SequenceStyleGenerator {
	public static final String VALUE_PREFIX_PARAMETER = "valuePrefix";
	public static final String VALUE_PREFIX_DEFAULT = "SP";
	...
	public void configure(Type type, Properties params, ServiceRegistry serviceRegistry) throws MappingException {
		...
		dateMonthFormat = ConfigurationHelper.getString(DATE_FORMAT_PARAMETER_MONTH, params, DATE_FORMAT_DEFAULT_MONTH).replace("%", "%1");
