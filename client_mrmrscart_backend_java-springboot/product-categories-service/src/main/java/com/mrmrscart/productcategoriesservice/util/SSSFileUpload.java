package com.mrmrscart.productcategoriesservice.util;

import static com.mrmrscart.productcategoriesservice.common.media.MediaConstant.UPLOAD_FAILURE;
...
public class SSSFileUpload {
	...
	public String uploadBase64ToS3Bucket(byte[] imageInByte, InputStream inputStream, String filePath,
			String imageExtention) {
		ObjectMetadata metadata = new ObjectMetadata();
		metadata.setContentLength(imageInByte.length);
		metadata.setContentType(imageExtention);
